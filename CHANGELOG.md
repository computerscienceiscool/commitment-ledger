...
<!-- commitment-ledger:conformance:start -->
### Conformance
...
notes:           Current commitment-ledger v0.1.0 emission for local frozen `commitment-promise-v1`.
```
...
scope:           full
breaking-change: false
notes:           Current commitment-ledger v0.1.0 emission for local frozen `commitment-evidence-v2`.
```
...
scope:           full
breaking-change: false
notes:           Current commitment-ledger v0.1.0 emission for local frozen `commitment-assessment-v2`.
```
...
scope:           full
breaking-change: false
notes:           Current commitment-ledger v0.1.0 emission for local frozen `implementation-conformance-v1`.
```
...
breaking-change: false
notes:           Retained in commitment-ledger v0.1.0 for reading older local `commitment-evidence-v1` artifacts; not emitted by current commands.
```
...
scope:           historical-read-only
breaking-change: false
notes:           Retained in commitment-ledger v0.1.0 for reading older local `commitment-assessment-v1` artifacts; not emitted by current commands.
```
<!-- commitment-ledger:conformance:end -->
